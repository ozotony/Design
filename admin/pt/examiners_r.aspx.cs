...
public partial class admin_pt_examiners_r : System.Web.UI.Page
{
    public string admin = "";
    public int back;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.limit = 50; this.nume = this.z.getPtInfoRSCnt("3", "Re-examine1"); Int64 pg = nume / limit; if ((pg > 0) && (nume > pg * limit)) { pg = pg + 1; }
        ...
        { base.Response.Redirect("./lo.aspx"); }
     //   this.lt_mi = this.z.getPtInfoRSX("3", "Re-examine1", dis.ToString(), limit.ToString());
