<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examination_details_a.aspx.cs" Inherits="admin_pt_examination_details_a" %>
    ...
    <table align="center" width="100%"  class="form">
       ...
       <%-- <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="True">
                    <asp:ListItem Value="Registrable" >Acceptance </asp:ListItem>
                 <asp:ListItem Value="NonRegistrable" >Refusal </asp:ListItem>
