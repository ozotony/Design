<%@ Page Language="C#" AutoEventWireup="true" CodeFile="registrar_r_details.aspx.cs" Inherits="admin_pt_registrar_r_details" MaintainScrollPositionOnPostback="true" %>
      ...
      <tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="True">
                    ...
                    <asp:ListItem Value="Deferred">Reject</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" colspan="2">
               ...
               <ASPP:PopupPanel style="text-align:center;" HeaderText="RD NO" Width="600px" Height="500px" ID="pup" runat="server" OnCloseWindowClick="MycloseWindow">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Label ID="Label5" Width="400px" runat="server" Text="Label"></asp:Label>
