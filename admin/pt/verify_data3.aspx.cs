...
public partial class admin_pt_verify_data3 : System.Web.UI.Page
{
    public string admin = "";
    public int back;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.limit = 50; this.nume = this.z.getPtInfoRSCnt("1", "Kiv"); Int64 pg = nume / limit; if ((pg > 0) && (nume > pg * limit)) { pg = pg + 1; }
        ...
        { base.Response.Redirect("../lo.aspx"); }
      //  this.lt_mi = this.z.getPtInfoRSX("1", "Kiv", dis.ToString(), limit.ToString());
