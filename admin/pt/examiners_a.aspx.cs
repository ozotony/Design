...
public partial class admin_pt_examiners_a : System.Web.UI.Page
{
    public string admin = "";
    public int back;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.limit = 50; this.nume = this.z.getPtInfoRSCnt("3", "Accepted"); Int64 pg = nume / limit; if ((pg > 0) && (nume > pg * limit)) { pg = pg + 1; }
        ...
        { base.Response.Redirect("./lo.aspx"); }
      //  this.lt_mi = this.z.getPtInfoRSX("3", "Accepted", dis.ToString(), limit.ToString());
    ...
    //    {
    //        lt_mi = z.getAdminSearchPtInfoRS("3", "Accepted", selectSearchCriteria.SelectedValue, fulltext, dateFrom, dateTo);
    //        if (lt_mi.Count() > 0)
    //        {
