<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examination_details_Kiv.aspx.cs" Inherits="admin_pt_examination_details_Kiv" validateRequest="false" %>
       ...
       <tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="True">
                 ...
                 <asp:ListItem Value="Kiv">Send Mail</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
