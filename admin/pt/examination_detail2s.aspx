<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examination_detail2s.aspx.cs" Inherits="admin_pt_examination_detail2s" %>
...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            <a href="./examiner2_unit/profile.aspx">PROFILE</a> 
       ...
       <tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="True">
                    ...
                    <asp:ListItem Value="Re-examine">Send To Examiner 1</asp:ListItem>
