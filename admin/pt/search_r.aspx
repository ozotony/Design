<%@ page language="C#" autoeventwireup="true" CodeFile="search_r.cs" inherits="admin_pt_search_r" %>
...
<body ng-controller="myController5">
  ...
  <div class="container">
        ...
        <div >
            <a href="./search_unit/profile.aspx">PROFILE</a><br /> <a href="../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> <a href="./search_unit/ved.aspx">VIEW STATISTICS</a>
        </div>
            </div>
...
&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td align="center">
               <a href="search_r_details.aspx?x=<%= lt_mi[i].xID.ToString() %>"><i class="fa fa-link"></i></a>
            </td>

            <td align="center">
               <a target="_blank" href="search_r_details.aspx?x=<%= lt_mi[i].xID.ToString() %>"><i class="fa fa-external-link"></i></a>
            </td>
        </tr>
        <% sn++; } 
             }%>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
               ...
               <a target="_blank" href="s_data_details_report.aspx?x={{row.xID}}"><i class="fa fa-file"></i></a>
                ...
                <td align="center">
               <a href="search_r_details.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="search_r_details.aspx?x={{row.xID}}"> <i class="fa fa-external-link"></i></a>
            </td>
