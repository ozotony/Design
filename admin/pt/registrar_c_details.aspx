<%@ Page Language="C#" AutoEventWireup="true" CodeFile="registrar_c_details.aspx.cs" Inherits="admin_pt_registrar_c_details" %>
...
<body>
   ...
   <div>
    <div class="container">
        <div class="sidebar">
            <a href="./registrar_unit/pt_profile.aspx">PROFILE</a> 
       ...
       <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Label ID="Label5" runat="server" Text="Label"><% Response.Write(lt_mi[0].reg_date); %></asp:Label>&nbsp;</td>
        </tr>
        ...
        <tr>
            <td align="right">
                ...
                <td>
                  <asp:Label ID="Label6" runat="server" Text="Label"><% Response.Write(lt_mi[0].reg_number); %></asp:Label>
                    </td>
        </tr>
         <tr>
            <td align="right"> 
            ...
            <td>
                ...
                <asp:Label ID="Label7" runat="server" Text="Label"><% Response.Write("OAI/DS/"+t.ValidationIDByPwalletID(lt_mi[0].log_staff) ); %></asp:Label></td>
        </tr>
         <tr>
        ...
        <tr>
            <td align="right">
                ...
                <td>
                  ...
                  <asp:Label ID="Label8" runat="server" Text="Label"><% Response.Write(lt_mi[0].xtype); %></asp:Label></td>
        </tr>
        <tr>
            <td align="right">
                &nbsp;TITLE OF DESIGN :
            ...
            <td>
                <asp:Label ID="Label9" runat="server" Text="Label"><% Response.Write(lt_mi[0].title_of_invention); %></asp:Label></td>
        </tr>
        <tr>
            <td align="right">
                TRANSACTION ID :
       ...
       <tr>
        ...
        <tr>
            ...
            <td>
                 <asp:Label ID="Label10" runat="server" Text="Label"><% Response.Write(lt_rep[0].agent_code); %></asp:Label>
                     </td>
        </tr>        
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Label11" runat="server" Text="Label"><% Response.Write(lt_rep[0].address); %></asp:Label></td>
        </tr>
...
<asp:Panel  Visible="false" runat="server"> 
        ...
        <tr>
            <td align="center" colspan="2">
                <a target="_blank" class="button" href="Design_Certificate.aspx?x=<%= lt_mi[0].xID.ToString() %>">View Certificate</a>
                <a target="_blank" class="button" href="Acceptance_Letter.aspx?x=<%= lt_mi[0].xID.ToString() %>">View Acceptance Letter</a>
                 <a target="_blank" class="button" href="Design_Akwnolgment.aspx?x=<%= lt_mi[0].xID.ToString() %>">View  Acknowledgement Letter</a>
