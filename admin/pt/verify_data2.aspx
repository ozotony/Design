<%@ Page Language="C#" AutoEventWireup="true" CodeFile="verify_data2.aspx.cs" Inherits="admin_pt_verify_data2" %>
...
<body ng-controller="myController2">
    ...
    <div class="container">
        ...
        <div >
            <a href="./verification_unit/profile.aspx">PROFILE</a><br /> <a href="../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> <a href="./verification_unit/ved.aspx">VIEW STATISTICS</a>
        </div>
            </div>
        ...
        <div class="content">
          ...
          <tr >
            <td   class="tbbg2"> &nbsp; WELCOME TO THE VERIFICATION UNIT</td>
          </tr>
          <tr class="stripedout">
            <td  align="center">
...
&nbsp;&nbsp;
        ...
        <%-- <table class="table form table-responsive">
          <tr >
            ...
            <td  class="tbbg2">View</td>
               <td  class="tbbg2">Open New Tab</td>
            </tr>
        ...
        <tr>
            ...
            <td align="center">
               <a href="verify_details2.aspx?x=<%= lt_mi[i].xID.ToString() %>"><i class="fa fa-link"></i></a>
            </td>
            <td align="center">
               
               <a target="_blank" class="icon-bar" href="verify_details2.aspx?x=<%= lt_mi[i].xID.ToString() %>"> <i class="fa fa-external-link"></i></a>
            </td>
        </tr>
        <% sn++; } 
             }%>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
                ...
                <td align="center">
               <a href="verify_details2.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="verify_details2.aspx?x={{row.xID}}"> <i class="fa fa-external-link"></i></a>
            </td>
