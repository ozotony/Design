<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examiners.aspx.cs" Inherits="admin_pt_examiners" %>
...
<body ng-controller="myController6">
  ...
  <div class="container">
        ...
        <div >
            <a href="./examiners_unit/profile.aspx">PROFILE</a><br /> <a href="../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> <a href="./examiners_unit/ved.aspx">VIEW STATISTICS</a>  <a href="../x_unit/profile4.aspx" ng-show="xvv" class="blinkytext" > <blink> <span id="txtblinkingtext" class="label label-danger" ng-bind="vcount"></span> </blink> </a>
...
&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td align="center">
               <a href="examination_details.aspx?x=<%= lt_mi[i].xID.ToString() %>"><i class="fa fa-link"></i></a>
            </td>

            <td align="center">
               <a target="_blank" href="examination_details.aspx?x=<%= lt_mi[i].xID.ToString() %>"><i class="fa fa-external-link"></i></a>
            </td>
        </tr>
        <% sn++; } 
             }%>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" ng-class="{'pending-delete': add2(row)}">
                ...
                <td align="center">
               <a href="examination_details.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="examination_details.aspx?x={{row.xID}}"> <i class="fa fa-external-link"></i></a>
            </td>
