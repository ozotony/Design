<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examination_details.aspx.cs" Inherits="admin_pt_examination_details" MaintainScrollPositionOnPostback="true" %>
       ...
       <tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="True">
                    <asp:ListItem Value="Accepted" >Issue Acceptance </asp:ListItem>
                 <asp:ListItem Value="Refused" >Issue Refusal </asp:ListItem>
                    <asp:ListItem Value="Further Examination">Further Examination</asp:ListItem>
                     <asp:ListItem Value="Reconduct search">Reconduct search</asp:ListItem>
        ...
        <tr>
            ...
            <tr>
            <td align="center" colspan="2">
                <asp:TextBox ID="TextBox1" runat="server" Height="50px" TextMode="MultiLine" Width="98%"></asp:TextBox>
