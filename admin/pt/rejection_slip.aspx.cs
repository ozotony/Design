...
public partial class admin_pt_rejection_slip : System.Web.UI.Page
{
    public string admin = "";
    public int back;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.limit = 50; this.nume = this.z.getPtInfoRSCnt("3", "Rejected"); Int64 pg = nume / limit; if ((pg > 0) && (nume > pg * limit)) { pg = pg + 1; }
        ...
        { base.Response.Redirect("../lo.aspx"); }
        this.lt_mi = this.z.getPtInfoRSX("3", "Rejected", dis.ToString(), limit.ToString());
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            lt_mi = z.getAdminSearchPtInfoRS("3", "Rejected", selectSearchCriteria.SelectedValue, fulltext, dateFrom, dateTo);
            if (lt_mi.Count() > 0)
            {
