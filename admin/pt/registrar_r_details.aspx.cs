...
public partial class admin_pt_registrar_r_details : System.Web.UI.Page
{
    public string admin = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            base.Response.Redirect("./registrar_r.aspx");
        }
    }
    ...
    protected void MycloseWindow(object sender, EventArgs e)
    {
        ...
        {
            Label5.Text = "Data not verified, Please try again later";
    ...
    protected void Verify_Click(object sender, EventArgs e)
    {
        ...
        if (this.rbValid.SelectedValue == "Registered")
        {
            int vno = z.getMaxRdno();
            string vno2 = (vno + 1).ToString().PadLeft(4, '0');
            Label5.Text = "RD No " + vno2 + " Generated";
            z.updatepwalletID(this.lt_mi[0].log_staff, vno2);
