...
public partial class admin_pt_examiner2s : System.Web.UI.Page
{
    public string admin = "";
    public int back;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.limit = 50;
        // this.nume = this.z.getPtInfoRSCnt("2", "Valid") + this.z.getPtInfoRSCnt("3", "Registrable"); Int64 pg = nume / limit; if ((pg > 0) && (nume > pg * limit)) { pg = pg + 1; }
        this.nume = this.z.getPtInfoRSCnt("4", "Further Examination"); Int64 pg = nume / limit; if ((pg > 0) && (nume > pg * limit)) { pg = pg + 1; }
        ...
        { base.Response.Redirect("./lo.aspx"); }
        // this.lt_mi = this.z.getPtInfoRSX("2", "Valid", dis.ToString(), limit.ToString());

     //   this.lt_mi = this.z.getPtInfoRSX("4", "Further Examination", dis.ToString(), limit.ToString());
    ...
    //    {
    //        // lt_mi = z.getAdminSearchPtInfoRS("2", "Valid", selectSearchCriteria.SelectedValue, fulltext, dateFrom, dateTo);

    //        lt_mi = z.getAdminSearchPtInfoRS("4", "Re-examine", selectSearchCriteria.SelectedValue, fulltext, dateFrom, dateTo);
    //        if (lt_mi.Count() > 0)
    //        {
