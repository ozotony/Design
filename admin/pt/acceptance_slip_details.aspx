<%@ Page Language="C#" AutoEventWireup="true" CodeFile="acceptance_slip_details.aspx.cs" Inherits="admin_pt_acceptance_slip_details" %>
       ...
       <tr>
        ...
        <tr>
            ...
            <td >
               ...
               {
                   Response.Write("<a href=" + lt_mi[0].rep_pic + " target='_blank'><img src=\"" + lt_mi[0].rep_pic + "\" height=\"50%\" width=\"50%\" /></a>");        
         }  else { Response.Write("NONE"); 
               } %></td>
        </tr>        
        <tr>
            ...
            <td >
               ...
               {
                   Response.Write("<a href=" + lt_mi[0].rep2_pic + " target='_blank'><img src=\"" + lt_mi[0].rep2_pic + "\" height=\"50%\" width=\"50%\" /></a>");        
         }  else { Response.Write("NONE"); 
               } %></td>
        </tr>
        <tr>
            ...
            <% if ((lt_mi[0].rep3_pic != "") && (lt_mi[0].rep3_pic != "0"))
               {
                   Response.Write("<a href=" + lt_mi[0].rep3_pic + " target='_blank'><img src=\"" + lt_mi[0].rep3_pic + "\" height=\"50%\" width=\"50%\" /></a>");        
         }  else { Response.Write("NONE"); 
               } %></td>
        </tr>        
        <tr>
            ...
            <td >
               ...
               {
                        Response.Write("<a href=" + lt_mi[0].rep4_pic + " target='_blank'> <img src=\""+ lt_mi[0].rep4_pic + "\" height=\"50%\" width=\"50%\" /></a>");        
         }  else { Response.Write("NONE"); 
               } %></td>
        </tr>
        ...
        <tr>
            <td  align="center" colspan="2">
             ...
             <strong>YOUR APPLICATION HAS BEEN ACCEPTED AND IS BEING PROCESSED FOR ISSUANCE OF CERTIFICATE OF REGISTRATION.<br />
              YOU WILL BE NOTIFIED FOR ONWARD COLLECTION</strong>
             <br />
               <img alt="Adewasiu" src="signatures/new_acceptance_sign.jpg" style=" width: 130px;height: 60px;" /><br />
