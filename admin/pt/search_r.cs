...
public partial class admin_pt_search_r : Page
{
    public string admin = "";
    public int back;
    ...
    {
        this.lt_mi = this.z.getPtInfoRSX("2", "Reconduct search", this.dis.ToString(), this.limit.ToString());
    }
    ...
    //    {
    //        this.lt_mi = this.z.getAdminSearchPtInfoRS("2", "Reconduct search", this.selectSearchCriteria.SelectedValue, fulltext, this.dateFrom, this.dateTo);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.limit = 50L;
        this.nume = this.z.getPtInfoRSCnt("2", "Reconduct search");
