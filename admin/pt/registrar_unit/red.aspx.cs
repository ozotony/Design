...
public partial class admin_pt_registrar_unit_red : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((this.fromdate != "") && (this.todate != ""))
        {
            ...
            this.g_new = this.z.getTotalEntryCountStageByDate("4", "Accepted", this.fromdate, this.todate);
            this.g_treated = this.z.getTotalEntryCountStageByDate("4", "", this.fromdate, this.todate);
            this.g_rejected = this.z.getTotalEntryCountByStage("4", "Deferred");
        }
        else
        {
            this.g_total = this.z.getTotalEntries("");
            this.g_utotal = this.z.getTotalEntries("4");
            this.g_new = this.z.getTotalEntryCountByStage("4", "Accepted");
