<%@ Page Language="C#" AutoEventWireup="true" CodeFile="acceptance.aspx.cs" Inherits="admin_pt_acceptance" %>
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
          ...
          <tr>
            <td colspan="8"  class="tbbg">WELCOME TO THE EXAMINER 2 UNIT</td>
          </tr>
          <tr class="stripedout">
...
&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td align="center">
               Registrable</td>
            <td align="center">
               <a href="acceptance_details.aspx?x=<%= lt_mi[i].xID.ToString() %>">View</a>
            </td>
        </tr>
        <% sn++; } 
             }%>
