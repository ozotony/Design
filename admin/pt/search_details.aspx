<%@ page language="C#" autoeventwireup="true" CodeFile="search_details.cs" inherits="admin_pt_search_details" maintainscrollpositiononpostback="true" %>
       ...
       <tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="True">
                 <asp:ListItem Value="Fresh" >Re-verify </asp:ListItem>  
                  <asp:ListItem Value="Search Conducted" >Search Report </asp:ListItem>
        ...
        <tr>
            <td align="center" colspan="2">
                ...
                <asp:Button ID="Verify" runat="server" Text="Send Report" OnClick="Verify_Click" class="button" />
            </td>
        </tr>
    </table>
        </div>
