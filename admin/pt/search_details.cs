...
public partial class admin_pt_search_details : Page
{
    public string admin = "";
   ...
   // public string rbval_text = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (this.rbValid.SelectedValue == "Fresh")
        {
            this.admin_status = "1";
            rbval_text = "Fresh";
            this.Verify.Visible = true;
    ...
    protected void Verify_Click(object sender, EventArgs e)
    {
      //  this.succ = this.z.a_tm_office(this.lt_mi[0].log_staff, this.admin_status, this.rbValid.SelectedValue, this.comment.Text, "", "", "", this.admin);
        ...
        this.succ = this.z.a_tm_office(this.lt_mi[0].log_staff, this.admin_status, this.rbval_text, this.comment.Text, "", "", "", this.admin);
