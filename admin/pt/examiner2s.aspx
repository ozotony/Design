<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examiner2s.aspx.cs" Inherits="admin_pt_examiner2s" %>
...
<%--<script tytype="text/javascript"pe="text/javascript" src="../../js/jquery.js"></script>--%>

<script  src="../../js/ui/jquery.cookie.js"></script>
...
<body ng-controller="myController11">
  ...
  <div class="container">
        ...
        <div >
            <a href="./examiner2_unit/profile.aspx">PROFILE</a><br /> <a href="../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> <a href="./examiner2_unit/ved.aspx">VIEW STATISTICS</a>
        </div>
            </div>
        ...
        <div class="content">
          ...
          <tr >
            <td   class="tbbg2"> &nbsp;  WELCOME TO THE EXAMINER 2 UNIT</td>
          </tr>
          <tr class="stripedout">
            <td  align="center">
...
&nbsp;&nbsp;
      ...
      <%--   <table class="table form table-responsive">
        ...
        <tr>
            ...
            <td align="center">
               <a href="examination_detail2s.aspx?x=<%= lt_mi[i].xID.ToString() %>"><i class="fa fa-link"></i></a>
            </td>

            <td align="center">
               <a target="_blank" href="examination_detail2s.aspx?x=<%= lt_mi[i].xID.ToString() %>"><i class="fa fa-external-link"></i></a>
            </td>
        </tr>
        <% sn++; } 
             }%>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
                ...
                <td align="center">
               <a href="examination_detail2s.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="examination_detail2s.aspx?x={{row.xID}}"> <i class="fa fa-external-link"></i></a>
            </td>
