<%@ page language="C#" autoeventwireup="true" CodeFile="search.cs" inherits="admin_pt_search" %>
...
<body ng-controller="myController4">
  ...
  <div class="container">
        ...
        <div >
            <a href="./search_unit/profile.aspx">PROFILE</a><br /> <a href="../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> <a href="./search_unit/ved.aspx">VIEW STATISTICS</a>  <a href="../x_unit/profile4.aspx" ng-show="xvv" class="blinkytext" > <blink> <span id="txtblinkingtext" class="label label-danger" ng-bind="vcount"></span> </blink> </a>
               <a style="width=200px;text-decoration:none" target="_blank" href="../pt/x_unit/profile4.aspx">UPDATE NOTIFICATIONS</a> 
        </div>
            </div>
   ...
   <%--  <a ng-repeat="(k, n) in news track by $index" ng-style="{'right':50px}" id="news_0" rel="nofollow" target="_blank"  href="{{n.link}}">--%>
    ...
    <div class="shadow right">&nbsp;</div>
          ...
          <tr >
            <td   class="tbbg2"> &nbsp;  WELCOME TO THE SEARCH UNIT</td>
          </tr>
          <tr class="stripedout">
            <td  align="center">
            &nbsp;<asp:Button ID="btnReloadPage" Visible="false" runat="server" class="button" 
                    onclick="btnReloadPage_Click" Text="RELOAD PAGE" />  <asp:Button ID="Button1" runat="server" class="button" 
                    onclick="btnReloadPage2_Click" Text="PERFORM SEARCH" OnClientClick="window.open('Searcho.aspx');return false;"  /> 
              </td>
          </tr>
         ...
         <tr>
          ...
          <tr  >
          <%--  <td   ><asp:DropDownList ID="selectSearchCriteria" runat="server" AutoPostBack="False">
...
&nbsp;&nbsp;
              ...
              key word:&nbsp;
              <input name="kword" type="text" id="kword"  size="40"   value="" runat="server"/>
          ...
          <tr class="stripedout">
            <td align="center">
                ...
                <asp:Button ID="btnSearch"  Visible="false" runat="server" Text="Perform SEARCH" class="button" OnClick="btnSearch_Click" 
                      />
                <br />
       ...
       <%--  <table class="table form table-responsive">
        ...
        <tr>
            ...
            <td align="center">
               <a target="_blank" href="s_data_details_report.aspx?x=<%= lt_mi[i].xID.ToString() %>"><i class="fa fa-file"></i></a>
            </td>
            <td align="center">
               <a href="search_details.aspx?x=<%= lt_mi[i].xID.ToString() %>"><i class="fa fa-link"></i></a>
            </td>

            <td align="center">
               <a target="_blank" href="search_details.aspx?x=<%= lt_mi[i].xID.ToString() %>"><i class="fa fa-external-link"></i></a>
            </td>
        </tr>
        <% sn++; } 
             }%>
                     ...
                     <table st-table="displayedCollection" st-safe-src="ListAgent" class="table  table-bordered table-responsive   ">
        <thead>
            <tr>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" ng-class="{'pending-delete': add2(row)}">
                ...
                <td align="center">{{row.title_of_invention}}</td>
                 ...
                 <td align="center">
               <a target="_blank" href="s_data_details_report.aspx?x={{row.xID}}"><i class="fa fa-file"></i></a>
            </td>
                <td align="center">
               <a href="search_details.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="search_details.aspx?x={{row.xID}}"> <i class="fa fa-external-link"></i></a>
            </td>
