<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examination_details_r.aspx.cs" Inherits="admin_pt_examination_details_r" %>
...
<body>
    ...
    <table align="center" width="100%"  class="form">
       ...
       <%-- <tr>
        ...
        <tr>
            <td align="center" colspan="2">
                 <a target="_blank" class="button" href="Refusal_Letter.aspx?x=<%= lt_mi[0].xID.ToString() %>">View Refusal Letter</a>
