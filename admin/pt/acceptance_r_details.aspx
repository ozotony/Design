<%@ Page Language="C#" AutoEventWireup="true" CodeFile="acceptance_r_details.aspx.cs" Inherits="admin_pt_acceptance_details" MaintainScrollPositionOnPostback="true" %>
       ...
       <tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="True">
                    <asp:ListItem Value="Certified" >Accept</asp:ListItem>
