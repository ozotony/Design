<%@ Page Language="C#" AutoEventWireup="true" CodeFile="verify_data3.aspx.cs" Inherits="admin_pt_verify_data3" %>
...
&nbsp;&nbsp;
       ...
       <%--  <table class="table form table-responsive">
        ...
        <tr>
            ...
            <td align="center">
               <a href="verify_details3.aspx?x=<%= lt_mi[i].xID.ToString() %>"><i class="fa fa-link"></i></a>
            </td>
            <td align="center">
               
               <a target="_blank" class="icon-bar" href="verify_details3.aspx?x=<%= lt_mi[i].xID.ToString() %>"> <i class="fa fa-external-link"></i></a>
            </td>
        </tr>
        <% sn++; } 
             }%>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
                ...
                <td align="center">
               <a href="verify_details3.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="verify_details3.aspx?x={{row.xID}}"> <i class="fa fa-external-link"></i></a>
            </td>
