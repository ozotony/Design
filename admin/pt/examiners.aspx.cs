...
public partial class admin_pt_examiners : System.Web.UI.Page
{
    public string admin = "";
    public int back;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // this.nume = this.z.getPtInfoRSCnt("2", "Valid") + this.z.getPtInfoRSCnt("3", "Registrable"); Int64 pg = nume / limit; if ((pg > 0) && (nume > pg * limit)) { pg = pg + 1; }
        this.nume = this.z.getPtInfoRSCnt("3", "Search Conducted"); Int64 pg = nume / limit; if ((pg > 0) && (nume > pg * limit)) { pg = pg + 1; }
     ...
     //   this.lt_mi = this.z.getPtInfoRSX("3", "Search Conducted", dis.ToString(), limit.ToString());
    ...
    //        lt_mi = z.getAdminSearchPtInfoRS("3", "Search Conducted", selectSearchCriteria.SelectedValue, fulltext, dateFrom, dateTo);
    //        if (lt_mi.Count() > 0)
    //        {
