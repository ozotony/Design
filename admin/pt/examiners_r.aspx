<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examiners_r.aspx.cs" Inherits="admin_pt_examiners_r" %>
  ...
  <div class="container">
       ...
       <%--  <table class="table form table-responsive">
        ...
        <tr>
            ...
            <td align="center">
               <a href="examination_r_details.aspx?x=<%= lt_mi[i].xID.ToString() %>"><i class="fa fa-link"></i></a>
            </td>

            <td align="center">
               <a target="_blank" href="examination_r_details.aspx?x=<%= lt_mi[i].xID.ToString() %>"><i class="fa fa-external-link"></i></a>
            </td>
        </tr>
        <% sn++; } 
             }%>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
                ...
                <td align="center">
               <a href="examination_r_details.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="examination_r_details.aspx?x={{row.xID}}"> <i class="fa fa-external-link"></i></a>
            </td>
