<%@ Page Language="C#" AutoEventWireup="true" CodeFile="registrar.aspx.cs" Inherits="admin_pt_registrar" MaintainScrollPositionOnPostback="true" %>
     ...
     <%--    <table class="table form table-responsive">
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
                ...
                <td align="center">
               <a href="registrar_details.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a>
            </td>

                 <td align="center">
               
               <a target="_blank" class="icon-bar" href="registrar_details.aspx?x={{row.xID}}"> <i class="fa fa-external-link"></i></a>
            </td>
