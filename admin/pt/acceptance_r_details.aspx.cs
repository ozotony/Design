...
public partial class admin_pt_acceptance_details : System.Web.UI.Page
{
    public string admin = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (this.rbValid.SelectedValue == "Rejected")
        {
            this.admin_status = "3";
            Verify.Visible = true;
        }
        ...
        {
            base.Response.Redirect("./acceptance_r.aspx");
        }
    }
