...
public partial class admin_pt_x_unit_edit_status : System.Web.UI.Page
{
    public string admin = "";
    public string agt;
    ...
    protected void Save_Click(object sender, EventArgs e)
    {
        if (xref.Text != "")
        {
            if (xref.Text.Contains("OAI/DS/"))
            {
                xref.Text = xref.Text.Replace("OAI/DS/", "");
            }
            r = xref.Text;
            ...
            if (lt_pw.Count > 0)
            {
                ...
                if (lt_pw[0].status == "1")
                {
                    ...
                    else
                    {
                        ...
                        data_status = lt_pw[0].data_status;
                    }
                }
                if (lt_pw[0].status == "2")
                {
                    status = "Design Search Office";
                ...
                if (lt_pw[0].status == "3")
                {
                    status = "Design Examiner 1 Office";
                ...
                if (lt_pw[0].status == "4")
                {
                    status = "Design Approving Office";
                ...
                if (lt_pw[0].status == "5")
                {
                    ...
                    if (lt_pw[0].data_status == "Review Design")
                    {
