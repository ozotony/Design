...
public partial class admin_pt_registrar_r : System.Web.UI.Page
{
    public string admin = "";
    public int back;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.limit = 50; this.nume = this.z.getPtInfoRSCnt("4", "Deferred"); Int64 pg = nume / limit; if ((pg > 0) && (nume > pg * limit)) { pg = pg + 1; }
        ...
        { base.Response.Redirect("../lo.aspx"); }
        this.lt_mi = this.z.getPtInfoRSX("4", "Deferred", dis.ToString(), limit.ToString());
    ...
    //    {
    //        lt_mi = z.getAdminSearchPtInfoRS("4", "Deferred", selectSearchCriteria.SelectedValue, fulltext, dateFrom, dateTo);
    //        if (lt_mi.Count() > 0)
    //        {
