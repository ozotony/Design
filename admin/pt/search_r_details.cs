...
public partial class admin_pt_search_r_details : Page
{
    public string admin = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            base.Response.Redirect("./search_r.aspx");
        }
    }
    ...
    {
        this.succ = this.z.a_tm_office(this.lt_mi[0].log_staff, this.admin_status, "Search Conducted", this.comment.Text, "", "", "", this.admin);
        if (this.succ != "0")
        {
