<%@ Page Language="C#" AutoEventWireup="true" CodeFile="verify_data.aspx.cs" Inherits="admin_pt_verify_data" %>
    ...
    <div class="container">
        ...
        <div class="content">
         ...
         <tr>
          ...
          <tr  >
              <td ><span us-spinner="{radius:30, width:10, length: 16}"></span></td>
         <%--   <td   >
...
&nbsp;&nbsp;
       ...
       <%--  <table class="table form table-responsive">
        ...
        <tr>
            ...
            <td align="center">
               <a href="verify_details.aspx?x=<%= lt_mi[i].xID.ToString() %>"><i class="fa fa-link"></i></a>
            </td>
            <td align="center">
               
               <a target="_blank" class="icon-bar" href="verify_details.aspx?x=<%= lt_mi[i].xID.ToString() %>"> <i class="fa fa-external-link"></i></a>
            </td>
        </tr>
        <% sn++; } 
             }%>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
               ...
               <a target="_blank" class="icon-bar" href="verify_details.aspx?x={{row.xID}}"> <i class="fa fa-external-link"></i></a>
            </td>
