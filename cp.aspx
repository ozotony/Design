   ...
   <div>
    ...
    <table align="center" width="100%">
     <tr>
        ...
        <tr>
            <td align="right">
            <asp:TextBox ID="xnewpass1" runat="server" Width="200px" CssClass="textbox" onunload="xnewpass1_Unload"></asp:TextBox>
                <% if (xnewpass1_text == "1")
                   { %>
        ...
        <tr>
            <td align="right">
            <asp:TextBox ID="xnewpass2" runat="server" Width="200px" CssClass="textbox" onunload="xnewpass2_Unload"></asp:TextBox>
                <% if (xnewpass2_text == "1")
                   { %>
                <img src="images/arrow-left.gif" alt="" width="16px" height="16px" />
                <%  } if (enable_Save == "0")
