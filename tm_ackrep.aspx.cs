...
public partial class tm_ackrep : System.Web.UI.Page
{
    public string aid = "";
    public string amt = "";
    public string gt = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((base.Request.QueryString["94384238SKFGKSDKGFSDKFSKFDKFD"] != null) && (base.Request.QueryString["94384238SKFGKSDKGFSDKFSKFDKFD"].ToString() != ""))
        {
            this.aid = base.Request.QueryString["94384238SKFGKSDKGFSDKFSKFDKFD"].ToString();
        }
        else
        {
            base.Response.Redirect("http://www.iponigeria.com/userarea/dashboard");
