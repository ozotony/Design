...
app.controller('formController', function ($scope, $state, $rootScope, $http, $stateParams, $location) {
    ...
    var serviceBase = serviceBaseDs + 'Handlers/Getupload_Email.ashx';
    ...
    $scope.add2 = function (vrow) {
        var serviceBase2 = serviceBaseDs + 'Handlers/GetEmail2.ashx';
        ...
        $http({
          ...
          .success(function (response) {
              ...
              if (dd.Data_Status == "Valid") {
                  vurl = serviceBaseDs +"admin/pt/search_details.aspx?x=" + dd.pt_id;

              }
              else if (dd.Data_Status == "Search Conducted") {

                  vurl = serviceBaseDs + "admin/pt/examination_details.aspx?x=" + dd.pt_id;
              }
...
app.controller('formController2', function ($scope, $state, $rootScope, $http, $stateParams, $location) {
    ...
    var serviceBase = serviceBaseDs + 'Handlers/GetOutbox_Email.ashx';
    $(document).ready(function () {
    ...
    $scope.add2 = function (vrow) {
        var serviceBase2 = serviceBaseDs + 'Handlers/GetEmail3.ashx';
