...
public class application_docs : Page, IRequiresSessionState
{
	protected InputFile fu_loa_doc;
	protected RegularExpressionValidator RegularExpressionLoa;
	protected InputFile fu_doa_doc;
	protected RegularExpressionValidator RegularExpressionDoa;
	protected InputFile fu_ns_doc;
	protected RegularExpressionValidator RegularExpressionNs;
	protected InputFile fu_pd_doc;
	protected RegularExpressionValidator RegularExpressionPd;
	protected InputFile fu_rep_doc;
	protected RegularExpressionValidator RegularExpressionRep;
	protected InputFile fu_rep2_doc;
	protected RegularExpressionValidator RegularExpressionRep2;
	protected InputFile fu_rep3_doc;
	protected RegularExpressionValidator RegularExpressionRep3;
	protected InputFile fu_rep4_doc;
	protected RegularExpressionValidator RegularExpressionRep4;
	protected ProgressBar pb_all_doc;
	protected Button btn_all_doc;
	protected Button btn_ack;
	...
	{
		if (this.Session["loa_newfilename"] != null)
		{
			this.loa_newfilename = this.Session["loa_newfilename"].ToString();
		}
		if (this.Session["doa_newfilename"] != null)
		{
			this.doa_newfilename = this.Session["doa_newfilename"].ToString();
		}
		if (this.Session["pd_newfilename"] != null)
		{
			this.pd_newfilename = this.Session["pd_newfilename"].ToString();
		}
		if (this.Session["ns_newfilename"] != null)
		{
			this.ns_newfilename = this.Session["ns_newfilename"].ToString();
		}
		if (this.Session["rep1_newfilename"] != null)
		{
			this.rep1_newfilename = this.Session["rep1_newfilename"].ToString();
		}
		if (this.Session["rep2_newfilename"] != null)
		{
			this.rep2_newfilename = this.Session["rep2_newfilename"].ToString();
		}
		if (this.Session["rep3_newfilename"] != null)
		{
			this.rep3_newfilename = this.Session["rep3_newfilename"].ToString();
		}
		if (this.Session["rep4_newfilename"] != null)
		{
			this.rep4_newfilename = this.Session["rep4_newfilename"].ToString();
		}
	...
	protected void btn_ack_Click(object sender, EventArgs e)
	{
		...
		{
			base.Response.Redirect("./tm_acknowledgement.aspx?0001234445XXX43943OPFDSMZXUHSJFDSKFGKSDKGFSDKFSKFDKFD=" + this.Session["vid"].ToString());
		}
		else
		{
